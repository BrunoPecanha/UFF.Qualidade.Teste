...
<body class="bg-light align-middle">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3">
                                    <div class="text-center">
                                        <img src="img/logouffazul.png" width="70px" height="70px" class="h4 text-gray-900 mb-4"><b><h1>Financeiro</h1></b>
                                    </div>
                                    <form class="user" method="post" action="${pageContext.request.contextPath}/AutenticacaoController">                                        
                                        <div class="form-group">
                                            <input type="text" maxlength="11" class="form-control form-control-user"
                                                id="cpf" name="cpf" onkeyup="validarNomeSenha()" placeholder="Informe seu cpf" onkeypress="return permiteSoNumeros(event)">                                               
                                        </div>
                                        <div class="form-group">
    ...
    <!-- End of Footer -->
    <script>
        //Funcao que formata o CPF via REGEX
