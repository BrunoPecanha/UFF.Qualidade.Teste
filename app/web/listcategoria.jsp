...
<head>
    ...
    <title>Financeiro - UFF - Categorias</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            ...
                            <p class="mb-4">Área para cadastro de categorias.</p> 
                        </div>
                        <div class="col-md-1">                            
                            <a href="#" onclick="alternarOperacaoNovoOuEdicao('categoriaModalLabel', 'novo', 'Categoria')" data-toggle="modal" data-target="#categoriaModal">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Área Admin > Categorias</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr> 
                                                ...
                                                <td> 
                                                    <div class="text-center">
                                                        <a href="#" onclick="carregarDadosEdicao('categoriaModalLabel', 'edit', 'Categoria', ['id', 'descricao'], [ '<c:out value='${categoria.id}'/>', '<c:out value='${categoria.descricao}'/>'])" data-toggle="modal" data-target="#categoriaModal">
                                                                <i class="fas fa-1x fa-edit pr-1"></i>                       
                                                        </a>
                                                        <a style="display:<c:out value="${categoria.possuiLancamento}" />" href="#" data-toggle="modal" onclick="carregarDadosEdicao('categoriaModalLabel', 'delete', 'Categoria', ['id_exclusao'], [ '<c:out value='${categoria.id}'/>'])"   data-target="#exclusaoModal">
    ...
    aria-hidden="true">
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title" id="categoriaModalLabel">Cadastro de Categorias</h5>
                   <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                       <span aria-hidden="true">×</span>
                   </button>
               </div>
               <!-- Corpo do modal -->
               <form method="post" action="${pageContext.request.contextPath}/CategoriaController?action=salvar">
                    <div class="modal-body">                    
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input  required="required" name="descricao" type="text" class="form-control" value="<c:out value="${categoria.descricao}" />" id="descricao" required>    
                            </div>
                        </div>                    
                    </div>
   ...
   <!--Fim modal de criação de categorias -->
    ...
    <!-- Modal de exclusão -->
        ...
        aria-hidden="true">
            <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">    
                        <form method="post" action="${pageContext.request.contextPath}/CategoriaController?action=delete">                            
                            <div class="modal-header">
                            ...
                            <input  name="id_exclusao" class="form-control" type="hidden"  value="<c:out value="${categoria.id}"/>" id="id_exclusao">   
                            <div class="modal-footer">
                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
